...
var author$project$Systems$BothSelected = F2(
	function (a, b) {
		return {$: 'BothSelected', a: a, b: b};
	});
var author$project$Systems$NoneSelected = {$: 'NoneSelected'};
var author$project$Systems$OneSelected = function (a) {
...
var author$project$Systems$outOfOrder = F4(
	function (i, j, x, y) {
...
var author$project$Systems$swap = F2(
...
var author$project$Systems$order = F2(
	function (array, selections) {
		if (selections.$ === 'BothSelected') {
			...
			var _n1 = _Utils_Tuple2(ai, aj);
			if ((_n1.a.$ === 'Just') && (_n1.b.$ === 'Just')) {
				var x = _n1.a.a;
				var y = _n1.b.a;
				return A4(author$project$Systems$outOfOrder, i, j, x, y) ? A2(author$project$Systems$swap, array, selections) : array;
			} else {
				return array;
			}
		} else {
...
var author$project$Systems$adjOrder = F2(
	function (array, selection) {
		if (selection.$ === 'Just') {
			var i = selection.a;
			return A2(
				author$project$Systems$order,
				array,
				A2(author$project$Systems$BothSelected, i, i + 1));
		} else {
			return array;
		}
	});
...
var author$project$Systems$increment = F2(
	function (array, index) {
		return (_Utils_cmp(
			index,
			elm$core$List$length(array) - 1) < 0) ? _Utils_Tuple2(
			A2(
				author$project$Systems$adjOrder,
				array,
				elm$core$Maybe$Just(index)),
			index + 1) : _Utils_Tuple2(array, index);
	});
var author$project$Systems$reset = F2(
	function (array, index) {
		return _Utils_Tuple2(array, 0);
	});
var author$project$Systems$select = F2(
	function (i, selections) {
		switch (selections.$) {
			case 'NoneSelected':
				return author$project$Systems$OneSelected(i);
			case 'OneSelected':
				var j = selections.a;
				return A2(author$project$Systems$BothSelected, j, i);
			default:
				var j = selections.a;
				var k = selections.b;
				return A2(author$project$Systems$BothSelected, j, k);
		}
	});
...
var author$project$SystemTest$b1suite = A2(
	elm_explorations$test$Test$describe,
	'The Bubblesort module',
	_List_fromArray(
		[
			A2(
			elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					...
					'select one item when one is already present',
					function (_n0) {
						return A2(
							elm_explorations$test$Expect$equal,
							A2(
								author$project$Systems$select,
								1,
								author$project$Systems$OneSelected(3)),
							A2(author$project$Systems$BothSelected, 3, 1));
					}),
					A2(
					elm_explorations$test$Test$test,
					'select one item when no item is selected',
					function (_n1) {
						return A2(
							elm_explorations$test$Expect$equal,
							A2(author$project$Systems$select, 1, author$project$Systems$NoneSelected),
							author$project$Systems$OneSelected(1));
					}),
					A2(
					elm_explorations$test$Test$test,
					'select when both are selected',
					function (_n2) {
						return A2(
							elm_explorations$test$Expect$equal,
							A2(
								author$project$Systems$select,
								3,
								A2(author$project$Systems$BothSelected, 4, 5)),
							A2(author$project$Systems$BothSelected, 4, 5));
					})
				])),
			A2(
				...
				[
					...
					function (_n3) {
						return A2(
							elm_explorations$test$Expect$equal,
							A2(
								author$project$Systems$swap,
								_List_fromArray(
									[10, 40, 50, 15]),
								A2(author$project$Systems$BothSelected, 0, 3)),
							_List_fromArray(
								[15, 40, 50, 10]));
					}),
					A2(
					...
					function (_n4) {
						return A2(
							...
							A2(
								...
								_List_fromArray(
									[10, 40, 50, 15]),
								author$project$Systems$OneSelected(2)),
							_List_fromArray(
								[10, 40, 50, 15]));
					})
				])),
					...
					function (_n5) {
						return A2(
							...
							A2(
								...
								_List_fromArray(
									[4, 7, 5, 9]),
								A2(author$project$Systems$BothSelected, 1, 2)),
							_List_fromArray(
								[4, 5, 7, 9]));
					}),
					A2(
					elm_explorations$test$Test$test,
					'both selected, no order',
					function (_n6) {
						return A2(
							elm_explorations$test$Expect$equal,
							A2(
				...
				[
					...
					function (_n9) {
						return A2(
							elm_explorations$test$Expect$equal,
							A2(
								author$project$Systems$increment,
								_List_fromArray(
									[2, 5, 1]),
								1),
							_Utils_Tuple2(
...
var author$project$Test$Generated$Main773111470$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/ojas/iiith/courses/SoftwareFoundations/lf/SoftwareFoundations2020/reference-bs/tests/Example.elm', '/home/ojas/iiith/courses/SoftwareFoundations/lf/SoftwareFoundations2020/reference-bs/tests/SystemTest.elm']),
		processes: 4,
	...
	elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'SystemTest',
				_List_fromArray(
					[author$project$SystemTest$b1suite])),
				A2(
				elm_explorations$test$Test$describe,
				'Example',
				_List_fromArray(
...
_Platform_export({'Test':{'Generated':{'Main773111470':{'init':author$project$Test$Generated$Main773111470$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-20609.sock";
